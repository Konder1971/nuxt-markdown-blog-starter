...
<template>
	...
	<SubHeader msg="About Us" />
	<UnderConten mgrtext="Lorem ipsum dolor sit amet, consectetur adipisicing elit." />
  
	<main>

    <article>
      <div class="article__block">
        <hgroup><h1 class="article__block--title">Article about us</h1></hgroup>
        <div class="article__block--dateauthor">
          <p>
            <span class="article__block--date">date: 22.05.2023</span>
        ...
        <div class="article__block--description">
          ...
          <div class="article__block--photo">
            ...
            <a href="src/assets/images/p.jpg" title="" data-lightbox="example"><img class="img--full" src="@/assets/images/p.jpg" alt=""></a>

            <div class="social__block">

              <h3 class="social__block--title">Subscribe to social</h3>
          ...
          <div class="article__block--text">
            ...
            <p>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugit, omnis numquam vero autem unde a. Sunt velit consequatur quasi ipsam enim minima, recusandae nam. Ipsum debitis harum aliquam, doloremque iure excepturi. Ratione libero corrupti cumque quas molestiae nisi aspernatur adipisci porro! Magni, officia delectus? Reiciendis facilis ut quia placeat, tempore ratione itaque vitae asperiores non, officia nulla! Quidem, blanditiis modi?
            </p>

            <div class="img">
              <a class="img--small" href="src/assets/images/f3.jpg" title="" data-lightbox="example"><img src="@/assets/images/f3.jpg" alt=""></a>
              <a class="img--small" href="src/assets/images/f4.jpg" title="" data-lightbox="example"><img src="@/assets/images/f4.jpg" alt=""></a>
            </div>

            <p>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugit, omnis numquam vero autem unde a. Sunt velit consequatur quasi ipsam enim minima, recusandae nam. Ipsum debitis harum aliquam, doloremque iure excepturi. Ratione libero corrupti cumque quas molestiae nisi aspernatur adipisci porro!
            </p>

            <div class="img">
              <a href="src/assets/images/p10.jpg" title="" data-lightbox="example"><img class="img--full" src="@/assets/images/p10.jpg" alt=""></a>
            </div>
...
.article__block--text .img .img--small {
  width: 47.5%;
}
